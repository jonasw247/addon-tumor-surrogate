...
train_arg.add_argument('--train_size', type=int, default=19000)
train_arg.add_argument('--val_size', type=int, default=1000)
...
train_arg.add_argument('--data_path', type=str, default='/mnt/8tb_slot8/jonas/datasets/tumorSimulationsIvanAtlas/DS_copy/')
